...
public class AddEvent extends AppCompatActivity implements View.OnClickListener{
    ...
    private EditText etTitle,etDescription,etVenue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etTitle = (EditText) findViewById(R.id.etETitle);
        etDescription = (EditText) findViewById(R.id.etEDescription);
        etVenue = (EditText) findViewById(R.id.etEVenue);
        etDate = (TextView) findViewById(R.id.etEDate);
        etTime = (TextView) findViewById(R.id.etETime);
        etRemind = (TextView) findViewById(R.id.etERemind);
        btSubmit = (Button) findViewById(R.id.btESubmit);
    ...
    private void saveEventDetails() {
        ...
        if (etVenue.getText().toString().isEmpty())
        ...
        query.saveEvent(title,description,venue,date,time,remind);
